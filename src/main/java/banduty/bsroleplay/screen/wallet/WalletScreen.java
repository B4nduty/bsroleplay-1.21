...
public class WalletScreen extends HandledScreen<WalletScreenHandler> {
    private static final Identifier TEXTURE = BsRolePlay.identifierOf("textures/gui/wallet_gui.png");
    private static final Identifier TEXTURE_OVERLAY = BsRolePlay.identifierOf("textures/gui/wallet_gui_overlay.png");
