...
public class CreativeShopScreen extends HandledScreen<CreativeShopScreenHandler> {
    ...
    private static final Identifier INCREASE_1K_BUTTON_TEXTURE = BsRolePlay.identifierOf("textures/gui/increase_1k.png");
    private static final Identifier INCREASE_1K_BUTTON_HOVER_TEXTURE = BsRolePlay.identifierOf("textures/gui/increase_1k_hover.png");
