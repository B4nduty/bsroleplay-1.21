...
public class BsRolePlayClient implements ClientModInitializer {
    ...
    public void onInitializeClient() {
        ...
        ColorProviderRegistry.ITEM.register((stack, tintIndex) ->
                tintIndex > 0 ? -1 : DyedColorComponent.getColor(stack, getColor(10511680)), ModItems.WALLET, ModItems.PIRATE_HELMET,
                ModItems.PIRATE_CHESTPLATE, ModItems.PIRATE_LEGGINGS, ModItems.GADGET_HAT);
