...
public class ModBlocks {
    ...
    public static final Block CLOCKPUNCH = Registry.register(Registries.BLOCK, BsRolePlay.identifierOf("clockpunch"),
            new Clockpunch(AbstractBlock.Settings.copy(Blocks.IRON_BLOCK).sounds(BlockSoundGroup.METAL).strength(80.0F, 8.0F).nonOpaque()));
